...
class LamdaSoftmaxWithLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit LamdaSoftmaxWithLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "LamdaSoftmaxWithLoss"; }
